...
const Show = () => {
  ...
  // Consistency: Use camelCase for function names
    ...
    if (window.confirm("Are you sure you want to delete this brand?")) {
      try {
        ...
        if (result.status === 200) {
          ...
          fetchBrands(); // Refresh list after delete
        } else {
                    ...
                    {loading ? (
                      <tr>
                        <td colSpan="4" className="text-center py-5">
                          ...
                          <div className="mt-2">Loading Brands...</div>
                        </td>
                      </tr>
                    ) : brands.length > 0 ? (
                      brands.map((brand) => (
                        <tr key={brand.id}>
                          ...
                          <td>
                            <span
                              className={`badge ${brand.status === 1 ? "text-bg-success" : "text-bg-danger"}`}
                            >
                          ...
                          <td>
                            ...
                            <button
                              onClick={() => deleteBrand(brand.id)} // Fixed: variable name matched
